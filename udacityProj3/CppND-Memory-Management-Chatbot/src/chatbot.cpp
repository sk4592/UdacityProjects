...
ChatBot::ChatBot (const ChatBot &src) { //copy constructor
    ...
    _image = new wxBitmap(); // created a new instance of image
    *_image = *src._image;   // copied the src image to this instance.
    _rootNode = new GraphNode(src._rootNode->GetID());
...
ChatBot &ChatBot::operator=(const ChatBot &src) { // copy assignment operator
    ...
    *_image = *src._image;   // copied the src image to this instance
    ...
    _rootNode = src._rootNode;
    _chatLogic = src._chatLogic;
    _chatLogic->SetChatbotHandle(this); // added this
}
